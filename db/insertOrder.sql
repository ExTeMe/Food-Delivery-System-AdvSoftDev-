...
--Order
INSERT INTO db.Order (Customer_ID, Order_Type, Coupon_ID, Status, Food_Rating, Driver_Rating, Food_Instructions, Food_Feedback)
VALUES(1, 'Delivery', NULL, 'Accepted', NULL, NULL, NULL, NULL);
